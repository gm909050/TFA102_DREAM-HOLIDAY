...
<a class="nav-link" href="<%=request.getContextPath()%>/seat/seatmap.jsp">餐廳平面圖</a>
        ...
        <div id="layoutSidenav_content">
            ...
            <div class='wrapper'>
                <div class='range'>
                    <form METHOD="post" enctype="multipart/form-data" ACTION ACTION="<%=request.getContextPath()+"/NearbyupdateServlet"%>" name="form1">
                        <h1>房型上架</h1><br>
                        <h4>基本資訊</h4>
                        ...
                        <div class="preview">
                            <img src="" name="name1" id="look1">
                            <p class="word">封面圖</p>
                        </div>
                        <div class="preview">
                            <img src="" name="name2" id="look2">
                            <p class="word">圖片1</p>
                        </div>
                        <div class="preview">
                            <img src="" name="name3" id="look3">
                            <p class="word">圖片2</p>
                        </div>
                        <div class="preview">
                            <img src="" name="name4" id="look4">
                            <p class="word">圖片3</p>
                        </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder='請輸入房型名稱..'
    ...
    <script>
        ...
        $(".save").on('click', function () {
            location.href = "/roombooking_management.html";
        });
