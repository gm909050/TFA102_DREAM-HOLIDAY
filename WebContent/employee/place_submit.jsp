...
// 	List<ManagementVO> list = manSvc.getAll();
...
<a class="nav-link" href="<%=request.getContextPath()%>/seat/seatmap.jsp">餐廳平面圖</a>
                ...
                <div class='range'>
                    <form>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder='請輸入場地名稱..'
                                aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                        </div>
                        <div class="text input-group">
                            <span class="input-group-text ">場地敘述</span>
                            <textarea id="form-control_3" class="form-control form-control_3" placeholder='請輸入場地敘述..'
                                aria-label=""></textarea>
                        </div>
                        <h4>銷售資訊</h4>
                        <div class="input-group mb-3">
    ...
    <script>
        ...
        $(".save").on('click', function () {
            location.href = "/placebooking_management.html";
        });
